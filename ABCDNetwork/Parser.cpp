 ...
 * Table of Contents:
 * 1. namespace parser
 *   1.1. inline void createConfigStream()
 *   1.2. inline string trim(string str)
 *   1.3. inline string getValidLine(ifstream &stream)
 *   1.4. inline void setNumLayers()
 *   1.5. inline void addParamToVars(string key, string value)
 *   1.6. inline void getNextParam()
 *   1.7. inline void loadWeightsFromFile(DARRAY3D weights, int* layerConfig)
 *   1.8. inline void saveWeightsToFile(DARRAY3D weights, int* layerConfig)
 *   1.9. inline void loadArrayFromExternalDataFile(string filePath, int numElements, DARRAY1D outputArray)
 *   1.10. inline void parseTruthTableInfo(string values, int numElements, DARRAY1D outputArray)
 *   1.11. inline void loadTruthTableFromFile(DARRAY2D truthTable, DARRAY2D expectedValues)
 *   1.12. inline void readConfigFile(string name)
 */
